...
def crop_to_roi(
    ...
    """Crop frames to a region of interest.
    ...
    Args:
        ...
        x_start: Fraction (0.0–1.0) for the left of the ROI.
        x_end: Fraction (0.0–1.0) for the right of the ROI.

    Returns:
        List of cropped frames.
    """
    if y_start == 0.0 and y_end == 1.0 and x_start == 0.0 and x_end == 1.0:
        return frames
    ...
    for frame in frames:
        ...
        cropped.append(frame[y1:y2, x1:x2].copy())
    return cropped
